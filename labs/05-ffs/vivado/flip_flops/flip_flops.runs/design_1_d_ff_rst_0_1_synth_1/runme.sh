...
HD_PWD='C:/DC_vivado_projects/flip_flops/flip_flops.runs/design_1_d_ff_rst_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_d_ff_rst_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_d_ff_rst_0_1.tcl
