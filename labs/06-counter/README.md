...
2. Calculate how many periods of clock signal with frequency of 100&nbsp;MHz contain time intervals 2&nbsp;ms, 4&nbsp;ms, 10&nbsp;ms, 250&nbsp;ms, 500&nbsp;ms, and 1&nbsp;s. Write values in decimal, binary, and hexadecimal forms.
   ...
   &nbsp;
   ![clock period](images/freq_final.png)
   &nbsp;

   ![number of periods](images/periods_final.png)
   &nbsp;
   <!--
   https://editor.codecogs.com/
   T_{clk}=\frac{1}{f_{clk}}=\frac{1}{100\cdot 10^{6}}=1\cdot 10^{-8}=10\textup{\,ns} \\
   \textup{number of clk period} = \frac{\textup{time interval}}{T_{clk}}= \frac{2\cdot 10^{-3}}{1\cdot 10^{-8}}=200\,000 \\
   -->

   | **Time interval** | **Number of clk periods** | **Number of clk periods in hex** | **Number of clk periods in binary** |
   | :-: | :-: | :-: | :-: |
   | 2&nbsp;ms | 200 000 | `x"3_0D40"` | `b"0011_0000_1101_0100_0000"` |
   | 4&nbsp;ms | 400 000 | `x"6_1A80"` | `b"110 0001 1010 1000 0000"` |
   | 10&nbsp;ms | 1 000 000 | `x"F_4240"` | `b"1111 0100 0010 0100 0000"` |
   | 250&nbsp;ms | 25 000 000 | `x"17D_7840"` | `b"1 0111 1101 0111 1000 0100 0000"` |
   | 500&nbsp;ms | 50 000 000 | `x"2FA_F080"` | `b"10 1111 1010 1111 0000 1000 0000"` |
